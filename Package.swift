...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/hxhlb/libghostty-spm/releases/download/storage.1.0.1782131350/GhosttyKit.xcframework.zip",
            checksum: "6942c4f6c339a632bb21227f4285380308e155e620f88ce4d5e98085b9752c57"
        ),
        .testTarget(
            name: "GhosttyKitTest",
