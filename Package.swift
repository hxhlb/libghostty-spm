...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/hxhlb/libghostty-spm/releases/download/storage.1.0.1782131349/GhosttyKit.xcframework.zip",
            checksum: "546407d7e16a01db9046b09076d3ee7d6325f39a73775f056901b57cd2695714"
        ),
        .testTarget(
            name: "GhosttyKitTest",
