...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/hxhlb/libghostty-spm/releases/download/storage.1.0.1780316001/GhosttyKit.xcframework.zip",
            checksum: "993c917af4b49c31d07d63917bea9e4f7aa4ebf02a5edc83be0320a3d198d74f"
        ),
        .testTarget(
            name: "GhosttyKitTest",
