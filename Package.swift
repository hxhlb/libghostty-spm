...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/hxhlb/libghostty-spm/releases/download/storage.1.0.1778493814/GhosttyKit.xcframework.zip",
            checksum: "b8f8da3d2464e3ed11b8d910962e08da877291dd37c445bfe980c29a9572d715"
        ),
        .testTarget(
            name: "GhosttyKitTest",
