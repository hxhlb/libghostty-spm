...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/hxhlb/libghostty-spm/releases/download/storage.1.0.1782131352/GhosttyKit.xcframework.zip",
            checksum: "a485b2979f38330d9e86949024a21b64294544d645d4843041a8f33cabff9797"
        ),
        .testTarget(
            name: "GhosttyKitTest",
