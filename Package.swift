...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/hxhlb/libghostty-spm/releases/download/storage.1.0.1782131347/GhosttyKit.xcframework.zip",
            checksum: "a8f258cec26a4e104006183fee68fa97a9ea26e5c07454824abbbaed50427ce4"
        ),
        .testTarget(
            name: "GhosttyKitTest",
