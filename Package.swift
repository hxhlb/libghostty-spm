...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/hxhlb/libghostty-spm/releases/download/storage.1.0.1779101078/GhosttyKit.xcframework.zip",
            checksum: "63fabbfec1a6fde12ed03996aa8c3c77c10ca4a5713706e3ac7520fd2c289f3f"
        ),
        .testTarget(
            name: "GhosttyKitTest",
