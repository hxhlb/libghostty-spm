...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Lakr233/libghostty-spm/releases/download/storage.1.1.4/GhosttyKit.xcframework.zip",
            checksum: "feab989335ed9be4ab0a01923b4d7f319c3bff63aabb4104474c686812cd3fd1"
        ),
        .testTarget(
            name: "GhosttyKitTest",
