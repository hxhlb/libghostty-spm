...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/hxhlb/libghostty-spm/releases/download/storage.1.0.1782131351/GhosttyKit.xcframework.zip",
            checksum: "c87d44f21dd39444cc185181c4dab6eb7054216cc1fa8b65f3d23343e848f748"
        ),
        .testTarget(
            name: "GhosttyKitTest",
