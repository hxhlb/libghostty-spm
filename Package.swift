...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/Lakr233/libghostty-spm/releases/download/storage.1.2.7/GhosttyKit.xcframework.zip",
            checksum: "1c3d62a635ac62f5402fd5083e7f5e2628f3da50f490b8456d37186163986df6"
        ),
        .testTarget(
            name: "GhosttyKitTest",
